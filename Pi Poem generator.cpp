...
int main() {
  ...
  cout << "3: ";
  random_index = rand() % three_letter_words.size();
  cout << three_letter_words[random_index] << endl;

  cout << "1: ";
  random_index = rand() % one_letter_words.size();
  cout << one_letter_words[random_index] << endl;

  cout << "4 : ";
  random_index = rand() % four_letter_words.size();
  cout << four_letter_words[random_index] << endl;
  ...
  cout << "5: ";
  random_index = rand() % five_letter_words.size();
  cout << five_letter_words[random_index] << endl;

cout << "9:";
    random_index = rand() % nine_letter_words.size();
  cout << nine_letter_words[random_index] << endl;

cout << "2:";
    random_index = rand() % two_letter_words.size();
  cout << two_letter_words[random_index] << endl;

  cout << "6:";
    random_index = rand() % six_letter_words.size();
  cout << six_letter_words[random_index] << endl;
